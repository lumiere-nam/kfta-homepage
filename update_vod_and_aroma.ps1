    ...
    <main class="bg-kftaLight py-12 px-6 relative font-sans text-gray-800">
        <div class="max-w-5xl mx-auto bg-white shadow-2xl rounded-3xl overflow-hidden border border-gray-200">
            <div class="bg-kftaGreen p-10 text-white">
                ...
                <h1 class="font-serif font-bold text-4xl lg:text-5xl mb-4">감정 아로마테라피</h1>
                <p class="text-lg opacity-90">무의식의 향기가 말해주는 나의 진짜 마음 찾기</p>
            </div>
            
            <div class="p-10 space-y-16">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                    <img src="assets/class_aroma_new.png" class="rounded-2xl w-full h-96 object-cover shadow-lg">
                    <div>
                        <h3 class="text-2xl font-bold text-kftaGreen mb-2">감정 아로마테라피</h3>
                        <p class="text-kftaRed font-bold mb-4">10가지 감정오일을 활용한 심리 치유 클래스</p>
                        <p class="text-gray-600 leading-relaxed text-justify mb-4">이유 없는 무기력함과 잦은 짜증에 시달리시나요? 억압된 감정은 피로와 원인 모를 불안으로 우리 몸을 공격합니다. 향기는 이성을 거치지 않고 감정과 기억을 관장하는 뇌의 변연계로 직접 전달되어 감정 스위치를 가장 빠르게 켜고 끕니다.</p>
                        <p class="text-gray-600 leading-relaxed text-justify mb-4">감정 아로마테라피는 열정, 평온, 용서, 안심, 동기부여 등 긍정적인 감정을 갖는데 도움을 주는 6종류의 블렌드 오일을 포함해 총 10가지 감정오일을 활용하여 현재 나의 무의식과 심리 상태를 진단하고 감정의 밸런스를 맞추는 과학적이고 섬세한 치유 과정입니다.</p>
                        ...
                        <ul class="list-disc list-inside text-sm text-gray-600 mb-6 space-y-2">
                            <li>1:1 블라인드 향기 심리 진단 (선호/불호 테스트)</li><li>식물 원료의 화학적 심리 솔루션 코칭</li><li>나만의 힐링 감정 롤온 향수(10ml) 맞춤 제작</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gray-50 border-t border-gray-200 p-6 sm:p-10">
                <div class="flex flex-col sm:flex-row justify-between items-center gap-6">
                    <div>
                        <h3 class="font-bold text-xl text-gray-800">감정 아로마테라피</h3>
                        <p class="text-sm text-gray-500">가격: 100,000원 / 소요 시간: 90분</p>
                    </div>
                    <a href="checkout.html?item=감정 아로마테라피" class="w-full sm:w-auto bg-kftaRed hover:bg-red-900 text-white font-bold py-4 px-12 rounded-full transition-all duration-300 shadow-lg text-lg text-center">
                        신청 및 결제하기
                    </a>
                </div>
            </div>
