...
$c = [regex]::Replace($c, '(?s)    <!-- Hero Section -->.*?    <!-- Sticky Bottom Apply Action -->', $newHTML)

# Write it out
[System.IO.File]::WriteAllText("c:\lumi\kfta\kfta-homepage\academy_vod_detail.html", $c, [System.Text.Encoding]::UTF8)
